...
const KNOWN_PHRASES: Record<string, string> = {
  ...
  "বীরখাল সমাজ কল্যাণ যুব সংগঠনের ঐক্যবদ্ধ কার্যক্রম": "Unified Community Welfare Activities of Birkhal Youth Social Welfare Organization",
  "বীরখাল সমাজ কল্যাণ যুব সংগঠনের ঐক্যবদ্ধ সমাজসেবা কার্যক্রম": "Unified Community Welfare Activities of Birkhal Youth Social Welfare Organization",
